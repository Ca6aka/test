...
export function RankingsPopup() {
  ...
  return (
    <>
      ...
      {/* Rankings Panel */}
      {isOpen && (
        <div className="fixed bottom-4 left-20 z-40 w-80 max-h-96 bg-slate-800/95 backdrop-blur-lg border border-slate-700/50 rounded-lg shadow-2xl overflow-hidden">
