...
const translations = {
  en: {
    ...
    ddosInstructions: 'Click on the red packets to destroy them before they reach your server. The speed increases over time!',
    firewallInstructions: 'Review each request and choose to Allow safe requests or Block dangerous ones. Be quick and accurate!',
  ...
  ru: {
    ...
    ddosInstructions: 'Кликайте по красным пакетам, чтобы уничтожить их до того, как они достигнут вашего сервера. Скорость увеличивается со временем!',
    firewallInstructions: 'Просматривайте каждый запрос и выбирайте Разрешить для безопасных запросов или Заблокировать для опасных. Будьте быстры и точны!',
    ...
    // Мини-игры переводы
    miniGames: 'Мини-игры',
    miniGamesDesc: 'Проверьте свои навыки в увлекательных мини-играх и зарабатывайте опыт!',
    minigame1: 'Защита от DDoS',
    minigame1Desc: 'Защитите свои серверы от входящих пакетных атак',
    minigame2: 'Фильтр Фаейрвола',
    minigame2Desc: 'Разрешайте легитимные запросы и блокируйте вредоносные',
    howToPlay: 'Как играть',
    ddosInstructions: 'Кликайте по красным пакетам, чтобы уничтожить их до того, как они достигнут вашего сервера. Скорость увеличивается со временем!',
    firewallInstructions: 'Просматривайте каждый запрос и выбирайте разрешить безопасные запросы или заблокировать опасные. Будьте быстрыми и точными!',
    gameCompleted: 'Игра завершена!',
    earnedXP: 'Вы заработали {amount} опыта!',
    packetsDestroyed: 'Пакетов уничтожено',
    correct: 'Правильно',
  ...
  ua: {
    ...
    reportTypeBug: 'Повідомлення про помилку',
    ...
    howToPlay: 'Як грати',
    ddosInstructions: 'Клікайте по червоних пакетах, щоб знищити їх до того, як вони досягнуть вашого сервера. Швидкість збільшується з часом!',
    firewallInstructions: 'Переглядайте кожен запит та вибирайте дозволити безпечні запити або заблокувати небезпечні. Будьте швидкими та точними!',
  ...
  de: {
    ...
    ddosInstructions: 'Klicken Sie auf die roten Pakete, um sie zu zerstören, bevor sie Ihren Server erreichen. Die Geschwindigkeit steigt mit der Zeit!',
    firewallInstructions: 'Überprüfen Sie jede Anfrage und wählen Sie sichere Anfragen zulassen oder gefährliche blockieren. Seien Sie schnell und genau!',
