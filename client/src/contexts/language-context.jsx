...
const newTranslations = {
  ...
  cryptoPaymentInfo: { en: 'Choose cryptocurrency and pay for VIP/Premium.', ru: 'Выберите криптовалюту и оплатите VIP/Premium.', ua: 'Оберіть криптовалюту і оплатіть VIP/Premium.', de: 'Wählen Sie Kryptowährung und zahlen Sie für VIP/Premium.' },
...
const translations = {
  ...
  ru: {
    ...
    serverSlotReward2: '+{amount} слот сервера',
    ...
    reportClosedRu: 'Закрыт',
    reportMarkedRu: 'Отмечен',
    ...
    characters: 'символов',
    reportSubjectRu: 'Тема отчета',
    reportType: 'Тип отчета',
    reportTypeFeature: 'Запрос функции',
    reportTypeComplaint2: 'Жалоба',
  ...
  ua: {
    ...
    reportClosedStatus: 'Закрито',
    reportMarkedStatus: 'Позначено',
    ...
    reportTypeComplaintMain: 'Скарга',
    ...
    reportTypeComplaintSecond: 'Скарга',
  ...
  de: {
    ...
    reportClosedStatusDE: 'Abgeschlossen',
    reportMarkedStatusDE: 'Markiert',
    ...
    reportTypeComplaintDE: 'Reklamation',
