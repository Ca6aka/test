...
const translations = {
  ...
  ru: {
    ...
    nicknameTooltip: 'Если нажать на свой или чужой ник, можно перейти на чей-то профиль',
    low: 'Низкий',
    moderate: 'Умеренный',
    high: 'Высокий',
  ...
  ua: {
    ...
    nicknameTooltip: 'Якщо натиснути на свій або чужий нік, можна перейти до профілю',
  },
  de: {
    tutorial: 'Tutorial',
    ...
    // Tooltips and hints
    profileTooltip: 'Klicken Sie auf Ihren Avatar, um den Fortschritt und andere interessante Informationen zu sehen',
    nicknameTooltip: 'Klicken Sie auf Ihren Spitznamen oder den von jemand anderem, um das Profil anzuzeigen',
    // Theme system
    darkTheme: 'Zum dunklen Design wechseln',
    lightTheme: 'Zum hellen Design wechseln',
    // Server durability system
    serverRepaired: 'Server repariert',
    serverRepairedDesc: 'Server für ${cost} repariert. Haltbarkeit wiederhergestellt: {durability}%',
