...
const newTranslations = {
  ...
  popular: { en: 'Popular', ru: 'Популярное', ua: 'Популярне', de: 'Beliebt' },
  maximum: { en: 'Maximum', ru: 'Максимальное', ua: 'Максимальне', de: 'Maximum' },
  vipBonusPackage: { en: 'VIP PACKAGE BONUSES:', ru: 'VIP ПАКЕТ БОНУСЫ:', ua: 'VIP ПАКЕТ БОНУСИ:', de: 'VIP-PAKET BONI:' },
  premiumBonusPackage: { en: 'PREMIUM PACKAGE BONUSES:', ru: 'PREMIUM ПАКЕТ БОНУСЫ:', ua: 'PREMIUM ПАКЕТ БОНУСИ:', de: 'PREMIUM-PAKET BONI:' },
  startingCapital: { en: 'starting capital', ru: 'стартового капитала', ua: 'стартового капіталу', de: 'Startkapital' },
  experience: { en: 'experience', ru: 'опыта', ua: 'досвіду', de: 'Erfahrung' },
  serverSlots: { en: 'server slots', ru: 'слотов серверов', ua: 'слотів серверів', de: 'Server-Slots' },
