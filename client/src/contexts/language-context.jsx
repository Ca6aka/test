...
const newTranslations = {
  ...
  // Donation system
  donateTitle: { en: 'Project Support', ru: 'Поддержка проекта', ua: 'Підтримка проекту', de: 'Projekt-Unterstützung' },
  donateDescription: { en: 'By supporting the game, you help improve the project and get new features. For this you get the bonuses listed below: VIP/Premium badges, experience acceleration, in-game currency and other privileges.', ru: 'Поддерживая игру, вы помогаете улучшать проект и получать новые функции. За это вы получаете бонусы, указанные ниже: VIP/Premium отметки, ускорение опыта, внутриигровую валюту и другие привилегии.', ua: 'Підтримуючи гру, ви допомагаєте покращувати проект та отримувати нові функції. За це ви отримуєте бонуси, зазначені нижче: VIP/Premium позначки, прискорення досвіду, внутрішньоігрову валюту та інші привілеї.', de: 'Durch die Unterstützung des Spiels helfen Sie, das Projekt zu verbessern und neue Funktionen zu erhalten. Dafür erhalten Sie die unten aufgeführten Boni: VIP/Premium-Abzeichen, Erfahrungsbeschleunigung, Spielwährung und andere Privilegien.' },
  securePayment: { en: 'Payment is secure and simple', ru: 'Оплата безопасно и просто', ua: 'Оплата безпечно і просто', de: 'Zahlung ist sicher und einfach' },
  cryptoPaymentInfo: { en: 'Choose cryptocurrency and pay for VIP/Premium.\nWe apologize for the high minimum amount — this is a platform limitation, not our game.\nNew to crypto? No problem! Contact us:\n📧 email@gmail.com | 📱 t.me/Ca6aka — we will guide you and make the payment step by step.', ru: 'Выберите криптовалюту и оплатите VIP/Premium.\nИзвиняемся за высокую минимальную сумму — это ограничение платформы, не нашей игры.\nНовичок в крипте? Не проблема! Свяжитесь с нами:\n📧 email@gmail.com | 📱 t.me/Ca6aka — подскажем и проведём оплату шаг за шагом.', ua: 'Оберіть криптовалюту і оплатіть VIP/Premium.\nВибачаємося за високу мінімальну суму — це обмеження платформи, не нашої гри.\nНовачок у крипті? Не проблема! Зв\'яжіться з нами:\n📧 email@gmail.com | 📱 t.me/Ca6aka — підкажемо і проведемо оплату крок за кроком.', de: 'Wählen Sie Kryptowährung und zahlen Sie für VIP/Premium.\nWir entschuldigen uns für den hohen Mindestbetrag — das ist eine Plattformbeschränkung, nicht unser Spiel.\nNeu in Krypto? Kein Problem! Kontaktieren Sie uns:\n📧 email@gmail.com | 📱 t.me/Ca6aka — wir führen Sie durch und machen die Zahlung Schritt für Schritt.' },
  ...
  popular: { en: 'Popular package', ru: 'Популярный пакет', ua: 'Популярний пакет', de: 'Beliebtes Paket' },
  maximum: { en: 'Maximum package', ru: 'Максимальный пакет', ua: 'Максимальний пакет', de: 'Maximales Paket' },
  vipBonusPackage: { en: 'VIP gift for purchasing the package', ru: 'VIP подарок за покупку пакетом', ua: 'VIP подарунок за покупку пакетом', de: 'VIP-Geschenk für den Kauf des Pakets' },
  premiumBonusPackage: { en: 'PREMIUM gift for purchasing the package', ru: 'PREMIUM подарок за покупку пакетом', ua: 'PREMIUM подарунок за покупку пакетом', de: 'PREMIUM-Geschenk für den Kauf des Pakets' },
  startingCapital: { en: 'Cash', ru: 'Наличные', ua: 'Готівка', de: 'Bargeld' },
  experience: { en: 'Experience', ru: 'Опыта', ua: 'Досвіду', de: 'Erfahrung' },
  serverSlots: { en: 'Server slots', ru: 'Слотов сервера', ua: 'Слотів сервера', de: 'Server-Slots' },
  ...
  // VIP features
  vipBadgeChat: { en: 'Blue VIP badge in chat and player profile.', ru: 'Синяя отметка VIP в чате и профиле игрока.', ua: 'Синя позначка VIP у чаті та профілі гравця.', de: 'Blaues VIP-Abzeichen in Chat und Spielerprofil.' },
  vipReducedCooldown: { en: 'Job cooldowns: 2m instead of 3m, 4m instead of 5m, 6m instead of 7m.', ru: 'КД на работы: 2м вместо 3м, 4м вместо 5м, 6м вместо 7м.', ua: 'КД на роботи: 2х замість 3х, 4х замість 5х, 6х замість 7х.', de: 'Job-Abklingzeiten: 2m statt 3m, 4m statt 5m, 6m statt 7m.' },
  vipExperienceBoost: { en: 'x1.5 experience from work.', ru: 'x1.5 опыта за работу.', ua: 'x1.5 досвіду за роботу.', de: 'x1.5 Erfahrung von der Arbeit.' },
  vipReportPriority: { en: 'Priority in reports, with VIP mark.', ru: 'Приоритет в репорте, с отметкой VIP.', ua: 'Пріоритет у звіті, з позначкою VIP.', de: 'Priorität in Berichten, mit VIP-Kennzeichnung.' },
  vipNewReaction: { en: 'Unique emojis for chat.', ru: 'Уникальные эмодзи для чата.', ua: 'Унікальні емодзі для чату.', de: 'Einzigartige Emojis für Chat.' },
  vipDailyBonus: { en: 'Daily login bonus +200 instead of +100.', ru: 'Бонус за ежедневный вход +200 вместо +100.', ua: 'Бонус за щоденний вхід +200 замість +100.', de: 'Täglicher Login-Bonus +200 statt +100.' },
  
  // Premium features
  premiumBadgeChat: { en: 'Purple PREMIUM badge in chat and player profile.', ru: 'Фиолетовая отметка PREMIUM в чате и профиле игрока.', ua: 'Фіолетова позначка PREMIUM у чаті та профілі гравця.', de: 'Lila PREMIUM-Abzeichen in Chat und Spielerprofil.' },
  premiumReducedCooldown: { en: 'Job cooldowns: 1.5m instead of 3m, 2m instead of 5m, 5m instead of 7m.', ru: 'КД на работы: 1.5м вместо 3м, 2м вместо 5м, 5м вместо 7м.', ua: 'КД на роботи: 1.5х замість 3х, 2х замість 5х, 5х замість 7х.', de: 'Job-Abklingzeiten: 1.5m statt 3m, 2m statt 5m, 5m statt 7m.' },
  premiumExperienceBoost: { en: 'x1.75 experience from work.', ru: 'x1.75 опыта за работу.', ua: 'x1.75 досвіду за роботу.', de: 'x1.75 Erfahrung von der Arbeit.' },
  premiumReportPriority: { en: 'Priority in reports, with PREMIUM mark.', ru: 'Приоритет в репорте, с отметкой PREMIUM.', ua: 'Пріоритет у звіті, з позначкою PREMIUM.', de: 'Priorität in Berichten, mit PREMIUM-Kennzeichnung.' },
  premiumNoMinigameCooldown: { en: 'Disabling cooldowns on mini-games.', ru: 'Отключение КД на мини-игры.', ua: 'Відключення КД на міні-ігри.', de: 'Deaktivierung der Abklingzeiten für Mini-Spiele.' },
  premiumInstantServers: { en: 'Instantly active servers — no mini-games needed for launch.', ru: 'Сразу активные сервера — мини-игры для запуска не нужны.', ua: 'Одразу активні сервери — міні-ігри для запуску не потрібні.', de: 'Sofort aktive Server — keine Mini-Spiele für den Start erforderlich.' },
  premiumSecretReactions: { en: 'Secret reaction to messages (visible only to administrators).', ru: 'Секретная реакция на сообщения (видна только администраторам).', ua: 'Секретна реакція на повідомлення (видна лише адміністраторам).', de: 'Geheime Reaktion auf Nachrichten (nur für Administratoren sichtbar).' },
  premiumNewReaction: { en: 'Premium emojis for chat.', ru: 'Премиальные эмодзи для чата.', ua: 'Преміальні емодзі для чату.', de: 'Premium-Emojis für Chat.' },
  premiumDailyBonus: { en: 'Daily login bonus +500 instead of +100.', ru: 'Бонус за ежедневный вход +500 вместо +100.', ua: 'Бонус за щоденний вхід +500 замість +100.', de: 'Täglicher Login-Bonus +500 statt +100.' },
  
  // Purchase buttons and messages
  purchaseVip: { en: 'Pay for VIP', ru: 'Оплатить VIP', ua: 'Оплатити VIP', de: 'VIP bezahlen' },
  purchasePremium: { en: 'Pay for PREMIUM', ru: 'Оплатить PREMIUM', ua: 'Оплатити PREMIUM', de: 'PREMIUM bezahlen' },
  ...
  months: { en: 'months', ru: 'месяцев', ua: 'місяців', de: 'Monate' },
