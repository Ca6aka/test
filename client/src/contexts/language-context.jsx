...
const translations = {
  en: {
    ...
    chatRule1: 'Be respectful to all players',
    chatRule2: 'No spam or flooding messages',
    chatRule3: 'No offensive language or harassment',
    chatRule4: 'English and Russian are preferred languages',
  ...
  ru: {
    ...
    chatRule1: 'Будьте вежливы ко всем игрокам',
    chatRule2: 'Не спамьте и не флудите',
    chatRule3: 'Запрещена нецензурная лексика и домогательства',
    chatRule4: 'Предпочтительные языки: русский и английский',
